	...
	\item 当$k_{52} \ge k_{42}$时，有以下区域划分
	      ...
	      \begin{table}[h]
		      ...
		      \begin{tabular}{|cc|c|c|c|cc|}
			      \hline
			      \multicolumn{5}{|c|}{$1 \times (3k_{51} - 3k_{41} + 3)$}                & \multicolumn{2}{|c|}{\multirow{4}*{$(3k_{52} - 3k_{42} + 3) \times 2$}}                                                                                        \\
			      \cline{1-5}
			      \multicolumn{2}{|c|}{\multirow{4}*{$(3k_{52} - 3k_{42} + 3) \times 2$}} & 4                                                                       & \multicolumn{2}{|c|}{$1 \times (3k_{51} - 3k_{41})$}                       &   &     \\
			      \cline{3-5}
			                                                                              &                                                                         & \multicolumn{3}{|c|}{$(3k_{52} - 3k_{42}) \times (3k_{51} - 3k_{41} + 1)$} &   &     \\
			      \cline{3-5}
			                                                                              &                                                                         & \multicolumn{2}{|c|}{$1 \times (3k_{51} - 3k_{41})$}                       & 5 &   & \\
			      \cline{3-7}
			                                                                              &                                                                         & \multicolumn{5}{|c|}{$1 \times (3k_{51} - 3k_{41} + 3)$}                             \\
			      \hline
		      \end{tabular}
